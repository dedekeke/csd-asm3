    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                ...
                // Duyệt cây BST theo chiều rộng sử dụng thuật toán Breadth-First Traversal (BFT)
                case 3 -> System.out.println(3);
                // Tìm kiếm thông tin của nhân viên theo mã nhân viên trong cây BST
                case 4 -> {
                    System.out.println("Input ID: ");
                    int id = scanner.nextInt();
                    Person personFind = person.search(id);
                    System.out.println(personFind.toString());
                }
                // Xóa đi một hồ sơ nhân viên dựa vào mã nhân viên trong cây BST
                ...
                // Tìm đường đi ngắn nhất khi đi từ thành phố A đến thành phố F bằng thuật toán Dijkstra theo yêu cầu dưới đây:
